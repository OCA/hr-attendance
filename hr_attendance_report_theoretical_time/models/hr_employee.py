...
class HrEmployee(models.Model):
    ...
    def write(self, vals):
        ...
        # If the theoretical_hours_start_date value or departure_date is modified
        # and there are attendance records with active=false generated by the cron
        # job, you must delete them to prevent inconsistent data from appearing in
        # the report.
        # We also create any pending attendance that have not been generated
        if "theoretical_hours_start_date" in vals or "departure_date" in vals:
            ...
            for item in self:
                ...
                date_to = item.departure_date or fields.Date.context_today(self)
                ...
                item._action_create_empty_attendance(date_from, date_to)
        return res
    ...
    def _action_create_empty_attendance(self, date_from=False, date_to=False):
        ...
        limit_date_to = self.departure_date or yesterday
